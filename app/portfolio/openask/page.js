      ...
      <Viewport>
        ...
        <Content>
          ...
          <PortfolioParagraph>
            ...
            Crypto creatives and integrate crypto payments on the platform. I
            was excited to work with a full team on my first commercialized
            product and thought this was an amazing opportunity to level up my
            skills!
          </PortfolioParagraph>
          <PortfolioParagraph>
          ...
          <PortfolioParagraph>
            ...
            contacting me. When someone attempts to connect with me on OpenAsk,
            it is a signal that they are serious about connecting and are
            willing to pay for my time.
          </PortfolioParagraph>
          <PortfolioParagraph>
          ...
          <ProjectImg
            alt="OpenAsk V1 Feed"
            src="/openask-media/openask-v1.png"
          />
          <PortfolioParagraph>
          ...
          <PortfolioParagraph>
            ...
            status could be completed, waiting, and expired. Questions are
            labeled as expired if they are not answered within 48 hours and the
            money is transferred back to the users account.
          </PortfolioParagraph>
          <PortfolioParagraph>
          ...
          <PortfolioParagraph>
            ...
            submit a question to a particular Sensei or answer a question that
            was asked to you.
          </PortfolioParagraph>
          <ProjectImg
            alt="OpenAsk V1 Ask"
          ...
          <PortfolioParagraph>
            ...
            question, the payment would be split evenly between the user asking
            the question and the sensei answering the question. We had to
            crearte a custom splitter smart contract to accomplish this.
          </PortfolioParagraph>
          <PortfolioParagraph>
            It was my first time working with solidity and implementing smart
            contracts with Javascript. It was a difficult process but I learned
            so much about how Solidity interacts with the frontend and all of
          ...
          <PortfolioParagraph>
            ...
            First, we changed our login method by implementing Web3Auth.
            Web3Auth allows users to login with any of the popular social media
            platforms such as Twitter, Facebook, and Google, as well as through
            an external crypto wallet such as Metamask. However, it also
            automatically creates a wallet for the user if they login through
            social media. We also started experimenting with audio answers for
            sensei's answering questions.
          </PortfolioParagraph>
          <ProjectImg
          ...
          <PortfolioParagraph>
            ...
            the proper functionality. On one hand, it was nice to have help on
            the design aspect of the project, but on the other hand, it was
            difficult to translate the designs into code. It was a great
            learning experience and I am very proud of my work.
          </PortfolioParagraph>
          <PortfolioParagraph>
          ...
          <PortfolioParagraph>
            It was important for us to condense the different tabs even further,
            as we felt the current pages were too overwhelming for the user. We
          ...
          <PortfolioParagraph>
            ...
            answers tab would only be viewable for sensei's as it would contain
            questions that they need to answer and have already answered. The
            profile tab would contain the users questions asked, questions
            eavesdropped, as well as their wallet and balance information.
          </PortfolioParagraph>
          <PortfolioParagraph>
          ...
          <PortfolioParagraph>
            ...
            prevent answers from getting leaked, we decided to only allow
            answers to be answered through audio. This way, you could verify the
            Sensei answered the question and that it could not be easily copied
            to another platform. I accomplished this using the JS audio recorder
            library and storing the audio files in the Alibaba Cloud.
          </PortfolioParagraph>
          <PortfolioParagraph>
            Additionally, we brought on 2 more backend developers to revamp our
            database and API. This would help improve the speed of the website
            and reduce the amount of data we were sending to the frontend.
          </PortfolioParagraph>
          <PortfolioParagraph>
            I encountered many problems with changing to a new database as most
          ...
          <PortfolioParagraph>
            ...
            input a code we would give them to become a sensei and sign up with
            Twitter in order to create their profile. They could also set a
            minimum amount that they would accept when asked a question.
          </PortfolioParagraph>
          <Title title="Conclusion" />
          <PortfolioParagraph>
            Unfortunately, OpenAsk was shut down due to lack of funding and
            trouble finding product-market fit. However, I am very proud of the
            work I did on this project and the skills I learned along the way.
            It was my first time working with a team on a commercialized product
            and I learned so much about the development process, from ideation
            to launch. I am excited to take these skills and apply them to
            future projects!
          </PortfolioParagraph>
        </Content>
      </Viewport>
