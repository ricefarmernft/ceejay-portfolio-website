...
import PortfolioParagraph from "../components/porfolioParagraph";
      ...
      <Viewport>
        ...
        <Content>
          ...
          <PortfolioParagraph>
            ...
            NFT project, is perhaps most famous for having many lost assets.
            Being one of the oldest NFT projects certainly means that some of
            these assets would be lost throughout the years, whether it be
            through lost private keys, death of the owner, or any variety of
            reasons. Punks were also famously a free project that had little to
            no value for years after their release. Predictably, many owners
            simply forgot about them because they were nearly worthless.
          </PortfolioParagraph>
          <PortfolioParagraph>
          ...
          <PortfolioParagraph>
            ...
            if a wallet containing a Punk has had no interactions in 4 years, it
            is considered lost:
          </PortfolioParagraph>
          ...
          <PortfolioParagraph>
            ...
            and display the data on a website with a clean UI. This way, anybody
          ...
          <PortfolioParagraph>
            ...
            counted for each data point. I also decided to display 12 lost apes
            at random to get visitors curious about the rest of the project.
          </PortfolioParagraph>
          <ProjectImg
            src="/forgotten-apes-media/forgotten-apes-home.png"
            alt="Forgotten Apes Home"
          ...
          <PortfolioParagraph>
            ...
            refreshed, it will randomize the order of apes. This creates a more
            dynamic page where you can truly see the wide assortment of apes for
            each criteria. I included a basic search box to search for apes by
            ID. I also included a few basic sorting functions to sort the grid
            of apes accordingly.
          </PortfolioParagraph>
          <ProjectImg
          ...
          <PortfolioParagraph>
            ...
            interesting but simple way. I love the BAYC artwork and seeing them
            in a grid showcases the variety of different apes out there.
          </PortfolioParagraph>
          ...
          <PortfolioParagraph>
            ...
            there is a single wallet with 27 apes in it that satisfies the Lost
            Apes criteria.{" "}
          </PortfolioParagraph>
          <ProjectImg
          ...
          <PortfolioParagraph>
            ...
            months until June 2022. This was an obvious data point to include in
            my research. The $APE coin claim was one of the most lucrative
            claims in the history of Ethereum. Each ape received 10,950 $APE
            coins, currently valued at nearly $40,000 (and valued at over $200k
            at its peak).{" "}
          </PortfolioParagraph>
          <TweetFormat tweetId="1504201556165644298" />
          <PortfolioParagraph>
            Due to my previous experience, I knew I could find this data using
            the Etherscan API. I would need to find the Apecoin Deployer address
            and extract the Logs from the Ethereum transactions. From there, I
            could find the ID of every ape that successfully claimed $APE coin
            and create an array of those values. I then created an array of
            numbers 0-9,999 to represent all ape IDs. Then I could compare the
            two arrays and the IDs that were not found in both arrays were the
            ape IDs that did not claim $APE coin. In total, I found that 96 apes
            did not claim $APE coin.
          </PortfolioParagraph>
          <SubTitle title="2. Unclaimed Dog" />
          <PortfolioParagraph>
            The Bored Ape Kennel Club claim was the first claim for ape holders
            in June 2021. This claim was only open for a week, so I expected
            there would be many more apes that did not claim their corresponding
            Dog. I did not expect to use this data as criteria for Lost Apes
            because this claim happened so long ago and was very short. But I
            knew finding this data would be quite easy since I had already
            written similar functions to find Unclaimed $APE.{" "}
          </PortfolioParagraph>
          ...
          <PortfolioParagraph>
            ...
            the Otherside Lands that they claimed after the public drop.
            However, Mutant lands were also included in this data. Luckily, ape
            lands were numbered 0-10,000, so I could simply filter by lands that
            were claimed by Yuga Labs and had an ID below 10,000. In total, I
            found that 266 apes did not claim their Otherside land.
          </PortfolioParagraph>
          ...
          <PortfolioParagraph>
            ...
            addresses are 0x0000 and 0xdead. Doing some research online, I
            decided to use the Alchemy API to find this data. I was able to
            filter the burn address by NFTs in the Bored Ape Contract and return
            the token ID hex that was present in the address. Then, using
            web3.js, I could translate that token ID hex to a token ID human
            readable number. I was able to follow this process for both burn
            addresses and combine the arrays together. In total, I found that 2
            apes have been burned.
          </PortfolioParagraph>
          <SubTitle title="5. No Transfers" />
          <PortfolioParagraph>
            The premise of this data point was simple enough. I wanted to find
            out how many apes have never been transferred. However, this proved
            extremely difficult. The fool proof way to do this was to check each
            ape individually and get their transaction count from the Alchemy
            API. However, I cannot call an API 10,000 times and loading this
            data would take too long for a Javascript project. So I had to
            improvise.
          </PortfolioParagraph>
          <PortfolioParagraph>
            ...
            all ethereum addresses holding an ape and their corresponding IDs at
            a certain block number. I choose to use the block number for the
            last minted ape to find the ape holders at sellout, and I would use
            the latest block to dynamically find the up to date list of ape
            holders. Then, I could compare the two arrays and if the address and
            ape ID matched, I could reasonably assume that that ape has never
            been “transferred”. Although this isn’t a perfect way to find this
            data, it was the best I could come up with. Some limitations
            include:
          </PortfolioParagraph>
          <div className="pt-3">
            <ul>
          ...
          <PortfolioParagraph>
            ...
            Lost Apes, I thought it was an interesting data point nonetheless
            and I would be able to use some parts of this component to find Lost
            Apes. In total, I found that 222 apes are in the same wallet that
            minted them.
          </PortfolioParagraph>
          ...
          <PortfolioParagraph>
            ...
            are lost forever? I decided to use 3 criteria to determine if an ape
            is lost:
          </PortfolioParagraph>
          <div className="pt-3">
            <ul>
          ...
          <PortfolioParagraph>
            ...
            did not claim $APE coin to the apes that did not claim Otherside
            land. The apes that appeared in both arrays satisfied the first two
          ...
          <PortfolioParagraph>
            ...
            return this data, so I had to get creative. First, I wanted to
            ...
            with the amount of apes in the address. I used a combination of the
            Alchemy API and web3.js to return the current holders of the 75
            apes. From there, I used web3.js to get the transaction count of
            each address to detect inactivity, similar to the strategy I used to
            find the No Transfers apes. However, I could not simply find the
            transaction count for each address, but the transaction count since
            the Otherside mint. To do this, I received the total transaction
            count for each address, and the total transaction count up to the
            block of the last Otherside mint. If there was no difference between
            the two counts, then the address has had no activity since the
            Otherside mint. I was then able to filter out the active ethereum
            addresses from the 75 apes. This eliminated 7 apes. In total, 68
            apes satisfied all 3 criteria.
          </PortfolioParagraph>
          <PortfolioParagraph>
            <strong>
          ...
          <PortfolioParagraph>
            ...
            technologies like React Router, React Redux, and Ant Design. I also
            had to find creative solutions to hard problems as well. Extracting
            data from the blockchain is not very fast, so I worked hard to
            minimize the amount of APIs calls and promises. Narrowing down my
            criteria for lost apes also took a lot of thinking and
          ...
          <PortfolioParagraph>
            ...
            indiviudal Lost Apes as an attempt to find the owners and understand
            how they became lost. While most investigations eventually run dry,
            there have been a couple successful outcomes.
          </PortfolioParagraph>
          ...
          <PortfolioParagraph>
            ...
            dogs. These tabs represent apes that have not claimed their sewer
            pass and dogs that have not been used to claim a sewer pass
