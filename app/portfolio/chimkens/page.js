    ...
    <>
      <Viewport>
        ...
        <Content>
          ...
          <PortfolioParagraph>
            On X, I saw some of his art previews of what would later become{" "}
            <a
              className="portfolio-link"
            ...
            . I was really impressed with the art and thought it was both
            unique, yet simple. He mentioned he used AI to help generate the
            art, as well as create his own manual edits. I decided to reach out
            to see if he was launching an NFT project and to see if there were
          ...
          <PortfolioParagraph className="pt-3">
            ...
            website, while Henlo would be respoonsible for the art and
            marketing. It was a great opportunity for us both to work on a new
            project, utilizing each of our strengths to collaborate and create.
          </PortfolioParagraph>
          <ProjectImg
          ...
          <PortfolioParagraph>
            ...
            offer it, as I had experience launching an NFT project before while
            it would be his first.
          </PortfolioParagraph>
          <PortfolioParagraph>
            He was inspired by Ohayo Labs and took a lot of similar themes from
            my project into Chimkens. Chimkens would be an AI focused project,
            with a low supply of 999 and a low mint price. There would be no
            promised utility, just good art and good vibes. We would do our best
            to not over-allocate the whitelist and give true supporters a chance
            to mint. And of course, I would create a custom website and smart
            contract in order to add novel features and a personal touch.
          </PortfolioParagraph>
          <PortfolioParagraph>
            ...
            ordinals on the other hand were rising, but it was quite expensive
            to inscribe Ordinals on Bitcoin. Meanwhile, Blast had just launched
            their layer 2. And Base was generating hype due to its low gas fees
            and ease of use.
          </PortfolioParagraph>
          <PortfolioParagraph>
          ...
          <ProjectImg
            alt="Chimkens FAQ"
            src="/chimkens-media/chimkens-faq.jpg"
          />
          <PortfolioParagraph>
            ...
            Chimkenlist and Ohayo list. I was able to negotiate 300 mint spots
            for the Ohayo community, and Henlo would create his own Chimkenlist
            for his supporters for the rest. Whitelist mint price would be .0069
            ETH. There would also be a public sale for any remaining unminted
            NFTs, which would have a price of .0088 ETH.
          </PortfolioParagraph>
          <ProjectImg
            alt="Chimkens Mint"
          ...
          <PortfolioParagraph>
            ...
            bots claimed most of the supply, and it was very difficult to mint
            if you were an average joe on the computer.
          </PortfolioParagraph>
          <ProjectImg
          ...
          <PortfolioParagraph>
            ...
            over-allocate the whitelist to ensure most if not all of the supply
            is minted fairly, thereby eliminating the public sale entirely. I
            can also keep the timing, price, and amount able to mint a secret,
            so bots cannot pre-plan their minting strategy. On the same
            rationalization, I can announce an initial price and change it at
            the last second, so only those minting through the front-end will be
            successful. And lastly, I can wait to verify the contract publicly
            until after mint, so bots cannot screen the contract functions and
            use them nefariously.
          </PortfolioParagraph>
          <PortfolioParagraph>
            In the end, I learned some great lessons and had some really
            important takeaways after the completion of Chimkens:
          </PortfolioParagraph>
          <ul className="list-disc ml-4 ">
            ...
            <li className="pt-3">
              ...
              lot easier as I could take my experience and prior work and
              rebrand a lot of it for Chimkens. I didn’t have to create the
              smart contract from scratch again, I could use the Ohayo contract
              as a base and update it accordingly. And although the website
              would look completely different, the Web 3 functions are usually
              the most time consuming part of building a mint website. Luckily,
              Ohayo was also a mint website so i could reuse a lot of the code
              to implement the same logic for Chimkens. Overall, the process was
              2x-3x faster programming Chimkens compared to Ohayo.
            </li>
            <li className="pt-3">
              Launching on Base was also a new but fun experience. I wanted to
              gain more experience on other blockchains, so I was really happy
              we decided to launch Chimkens on Base rather than Ethereum. Having
              negligible gas fees meant I could be more loose with the smart
              contract and add more functions and checks without the extra cost
              of gas. The contract would be safer in a way because I wouldn’t
              have to worry about cost when deploying and interacting with the
              contract.
            </li>
            <li className="pt-3">
              ...
              verify the contract, changing the contract shortly before mint,
              and hiding functionality on the front-end can help reduce the
              amount of bots that snipe the public sale.
            </li>
          </ul>
          <ProjectImg
          ...
          <PortfolioParagraph>
            ...
            different responsibilities, and developing that trust that each one
            of us is doing our jobs correctly with pride.
          </PortfolioParagraph>
          <PortfolioParagraph className="pt-3">
            I'm not exactly sure what's next, but I definitely plan on
            developing new projects or joining existing teams as the bull run
            continues this year. There is so much more opportunity out there, so
            I'm sure I won't be bored for too long!
          </PortfolioParagraph>
        </Content>
      </Viewport>
    </>
