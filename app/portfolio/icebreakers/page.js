      ...
      <Viewport>
        ...
        <Content>
          ...
          <PortfolioParagraph>
            ...
            match. Sometimes, I would be stuck on a particular match for
            ...
            lot of time, as I would have to spin up the website and come up with
            an appropriate prompt. I eventually had enough and decided to come
            up with my own seamless solution to this problem by creating an AI
            app that would generate "icebreakers". And so, icebreakers was born!
          </PortfolioParagraph>
          <List
          ...
          <PortfolioParagraph>
            ...
            first, as that is where most online dating takes place. Luckily, the
            MUI library makes it easy to create responsive websites. I also
            designed the MUI components to be as simple as possible. My main
            goal was to make this app easy and fast to use. For the logo, I used{" "}
            <a
            ...
            For the coloring, I wanted to use shades of blue and pink to
          ...
          <PortfolioParagraph>
            ...
            to make this process easier and quicker. With icebreakers, you
            simply input your matches name, gender, and a fun fact. Then, click
            generate and the app will return unique icebreakers that you can
            either copy and paste straight into the dating app or take
          ...
          <PortfolioParagraph>
            ...
            are dozens of models you can choose from and I decided to go with
            the GPT 3.5 model. I would have used GPT 4, the latest update, but I
            have not been granted access yet. However, GPT 3.5 would be
            sufficient for now, as that is the model that standard Chat GPT is
            based off of.
          </PortfolioParagraph>
          <PortfolioParagraph>
            ...
            icebreakers. If I were to collect feedback on the icebreakers, this
          ...
          <PortfolioParagraph>
            ...
            with a great standard prompt. I experimented with a variey of
            prompts until I found one that would return longer icebreakers that
            swayed to the funny and clever style. Personally, I wanted the app
            to match my humor and I also wanted the icebreakers to seem
            thoughtful and drawn out a bit.
          </PortfolioParagraph>
          <PortfolioParagraph>
            There were also multiple different settings you can choose from
            using GPT 3.5. These included temperature, number of iterations, and
            max characters. Temperature is the uniqueness of the outputs.
            Basically, a higher temperature means you would receive a more
            unique and sometimes strange response. I set this to the max because
            I wanted the most unique outputs you could come up with. For number
            of iterations, I choose 3. I wanted the user to be able to choose
            between a few icebreakers, but I also had to be aware of the costs.
            This also coincides with max tokens, which represents the length of
            the icebreaker. I didn't want the icebreakers to be too long as it
            would cost more. And for now, I am bootstrapping the app out of my
            own pocket.
          </PortfolioParagraph>
          <PortfolioParagraph>
            ...
            gender inputted into the respective fields. Fun fact is an optional
            input, but I would strongly reccomend filling it in as it provides
            much better icebreakers. I also added an uppercase and lowercase
            switch to format the outputs according to your personal preference
            if you were to copy and paste the icebreakers straight into the
            dating app. Lastly, I added a clear form button as a fast way to
          ...
          <PortfolioParagraph>
            ...
            get a positive response, which I can then continue the conversation
          ...
          <PortfolioParagraph>
            ...
            form where I can gather data on the best icebreakers. But for now, I
            will continue using icebreakers to save time and accelerate my
          ...
          />
          <PortfolioParagraph>
            Icebreakers has been updated to use the GPT4 API!
          </PortfolioParagraph>
          <PortfolioParagraph>
            ...
            generator and then modify it slightly to your personality, as the
