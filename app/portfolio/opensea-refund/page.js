      ...
      <Viewport>
        ...
        <Content>
          ...
          <p>
            ...
            read etherscan and export all of their failed Opensea transactions.
          </p>
          {/* <TweetFormat tweetId="1591218382216404992" /> */}
          <PortfolioParagraph>
            That weekend I started thinking: How can I make this process easier
            for the average individual? Speed was of the essence here as I
            wanted to capture as many users as I could while this post was
            viral. I had never worked with blockchain data before, but I figured
            this was a simple enough problem that it was the perfect time to
            start. So I got to work!
          </PortfolioParagraph>
          <List
          ...
          <PortfolioParagraph>
            ...
            constraint and the practicality I wanted for the app. There would be
            an input for the Ethereum address to check, a balance checker, and a
            table to showcase all of your transactions. Also, I added a dark
            mode option.
          </PortfolioParagraph>
          <Title title="Vision" />
          <PortfolioParagraph>
            ...
            by simply inputting your Ethereum address. I wanted to display it in
            a simple table with the date, transaction hash, gas fee, and
          ...
          />
          <PortfolioParagraph>
            I had never worked with blockchain data before so my first step was
            to find an API that could filter the entire history of someones
            Ethereum address. This proved rather easy though since etherscan has
            a free API that you can use for personal projects. This would work
            perfectly!
          </PortfolioParagraph>
          <PortfolioParagraph>
            ...
            Ether balance to the right. This way, the user could confirm that
            they inputted their address in correctly.
          </PortfolioParagraph>
          <PortfolioParagraph>
            Then came the more technical part of the app: filtering the ethereum
            transactions. There were two basic criteria I needed to filter out
            the transactions by: failed transactions, and interactions with the
          ...
          <PortfolioParagraph>
            ...
            it to Ether. I could then find the total amount of gas, which is the
          ...
          <PortfolioParagraph>
            ...
            would help a few people who had not received their reimbursement yet
            or were unable to find their reimbursement amount. The response I
            got was extraordinary!
          </PortfolioParagraph>
          ...
          <PortfolioParagraph>
            ...
            receiving. Let me tell you, it is a great feeling creating something
            so useful. It reaffirmed my belief that users want something fast
            and simple, which was exactly what this app was. Here are some of my
            favorite responses and feedback:
          </PortfolioParagraph>
          ...
          <PortfolioParagraph>
            ...
            styling and create a more aesthetically pleasing website and a
            better UI / UX for the user.
          </PortfolioParagraph>
          <PortfolioParagraph>Here is what I came up with:</PortfolioParagraph>
          <ProjectImg
            href="https://www.osrefund.app/"
          ...
          <PortfolioParagraph>
            ...
            wavy background using the Haikei app. I thought this was appropriate
            as a nod to 'Opensea'. I revamped to an aqua and pink color theme
            and also reduced the font weights to create a more minimalistic
            look. Instructions were added to the top as well as direct links to
            the Opensea Help Center. For the transaction table, I removed the
            'Link' column and instead added the etherscan links to the 'Tx Hash'
            data. I also made the table transparent and added a box shadow to
          ...
          <PortfolioParagraph>
            ...
            Ethereum address. I also added a 'Sort 30 Days' button to adhere to
            the new Opensea policy of only allowing refunds within 30 days. This
            would make it easier for frequent users to quickly check if they are
            eligible for any more refunds. I added a simple Loader that shows up
            when you input an Ethereum Address or a .eth ENS so you know that
            the table is generating. Lastly, I decided to remove the export to
            XLS button due to the fear of malware and increasing download scams.
            Instead, I replaced it with a 'Copy Table' button which will neatly
            copy your Table to the clipboard. From here, you can paste it in
            Excel or forward it to the Opensea Help Center. I figured this would
            be safer than downloading an actual file.
          </PortfolioParagraph>
          <PortfolioParagraph>
          ...
          <PortfolioParagraph>
            Unfortunately, Opensea has decided to shutdown the refund policy and
            placed a DMCA on my webiste. I suspect it may be due to my
            application going viral, and Opensea struggling as a company.
            Although it pains me to see my time, effort, and innovation
            eventually becoming fruitless, I learned a lot about developing and
            marketing a useful application like Opensea Refund. Feel free to
