    ...
    <>
      <Viewport>
        ...
        <Content>
          <Title title="Vision" />
          <PortfolioParagraph>
            When the USA Department of Justice released the Epstein files in
            late 2025, I was immediately intrigued. I had followed the Epstein
            saga for years, and was fascinated with the dark world of Jeffrey
            Epstein, his connections, and the many mysteries surrounding his
            life and death.
          </PortfolioParagraph>
          <PortfolioParagraph>
            However, I was disappointed that the files were just a massive dump
            of unorganized PDFs that were nearly impossible to sift through. I
            wanted to create a more user friendly way to explore the files, and
            thus the Epstein Library was born.
          </PortfolioParagraph>
          <PortfolioParagraph>
            The Epstein Library is a web application that allows users to easily
            browse, search, and view the Epstein files in a more organized
            manner. Users can search by dataset, filter by file type, filter by
            most viewed, and view files in a clean and intuitive interface. The
            goal of the Epstein Library is to make the Epstein files more
            accessible to the public and to shed light on the dark world of
            Jeffrey Epstein.
          </PortfolioParagraph>
          <PortfolioParagraph>
            After sharing the initial version of the Epstein Library on Reddit,
            it quickly gained traction and went viral, reaching over 150,000
            views and 500+ upvotes. In 2 weeks, the website reached 11,000+
            unique visitors. The response has been overwhelmingly positive, with
            many users praising the ease of use and organization of the files.
          </PortfolioParagraph>
          <PortfolioParagraph>
          ...
          <ul className="pt-3 list-disc pl-5 space-y-2">
            ...
            <li>
              Community tagging feature to add context and metadata for
              searchable images
            </li>
            <li>Mobile friendly viewing with swipe navigation</li>
            <li>Privacy first access with no account required</li>
            <li>
              Images are stored on Cloudflare R2 for fast, cost-efficient
              delivery at scale
            </li>
            <li>
              Metadata, view counts, and tags are managed in a PostgreSQL
          ...
          <PortfolioParagraph>
            ...
            usability, and transparency. My goal is to keep improving the
            tooling around it while staying mindful of the responsibility that
            comes with presenting sensitive public records.
          </PortfolioParagraph>
        </Content>
      </Viewport>
    </>
